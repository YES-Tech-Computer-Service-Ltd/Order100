<?php
namespace Order100\Notification\Engine\Builder;
    ...
    public function build() {
        ...
        foreach ( $this->elements as $element ) {
            ...
            if ( isset( $element['integration'] ) && '3rd' === $element['integration'] ) {
                $class = 'Order100\Notification\Engine\Integrations\\' . $element_type;
            } elseif ( ! empty( $element['addon_namespace'] ) ) {
                $class = $element['addon_namespace'] . '\\Elements\\' . $element_type;
            } else {
                $class = 'Order100\Notification\Engine\Elements\\' . $element_type;
            }
