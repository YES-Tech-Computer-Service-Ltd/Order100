...
abstract class BaseEmail {
     ...
     */
    public $email_types = [ O100NE_WITH_ORDER_EMAILS ];
     ...
     * @var int
     */
    protected $render_priority = O100NE_EMAIL_RENDER_PRIORITY;

    /**
     * Callback for o100ne_emails hook
    ...
    public function get_template_file( $located, $template_name, $args ) {
        ...
        $this->template = new O100neTemplate( $this->id );
    ...
    public function maybe_disable_block_email_editor() {
        ...
        $find_o100ne_template = TemplateModel::get_short_data_by_name( $this->id );
        if ( ! empty( $find_o100ne_template ) && $find_o100ne_template['status'] === 'active' ) {
