...
function convert_json_elements_to_php( $json, $class_name, $section_type, $pattern_type, $pattern_name, $position = 10 ) {
    ...
    // Add imports
    $php .= "use Order100\Notification\Engine\\Abstracts\\BasePattern;\n";
    ...
    foreach ( $element_types as $element_type ) {
        ...
        $php               .= "use Order100\Notification\Engine\\Elements\\{$element_class_name};\n";
    }

    $php .= "use Order100\Notification\Engine\\TemplatePatterns\\SectionTemplates\\{$section_type};\n";
    $php .= "use Order100\Notification\Engine\\Utils\\SingletonTrait;\n\n";
    ...
    $php .= "        \$this->name     = __('{$pattern_name}', 'order100');\n";
    $php .= "        \$this->elements = [\n";
