...
class Banner4 extends BasePattern {
    ...
    public function __construct() {
        ...
        $this->position = 40;
        $this->name     = __( 'Banner 4', 'order100' );
        $this->elements = [
            ColumnLayout::get_object_data(
                ...
                [
                    ...
                    'background_image'       => [
                        'url'        => 'https://images.wpbrandy.com/uploads/o100ne-banner-4-img-1-scaled.png',
                        'position'   => 'custom',
                        'x_position' => 100,
                        'y_position' => 0,
                        'size'       => 'custom',
                            ...
                            [
                                'children' => [
                                    Image::get_object_data(
                                        [
                                            'src'     => 'https://images.wpbrandy.com/uploads/o100ne-banner-4-img-2.png',
                                            'padding' => [
                                                'top'    => 10,
                                                'bottom' => 0,
                                                'right'  => 10,
                        ...
                        Column::get_object_data(
                            ...
                            [
                                'children' => [
                                    ...
                                    Text::get_object_data(
                                        [
                                            'rich_text'  => '<p style="font-size: 14px; text-align: center; margin: 0px;"><span style="font-size: 16px;"><span style="text-decoration: underline;">Explore Now</span> <img src="https://images.wpbrandy.com/uploads/o100ne-banner-img-arrow-1.png" style="width:20px !important; height:20px !important;" alt="" width="12" height="12" /></span></p>',
                                            'background_color' => '#ffffff00',
                                            'text_color' => '#333439',
                                            'padding'    => [
                                                'top'    => 0,
