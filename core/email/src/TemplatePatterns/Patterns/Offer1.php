        ...
        $this->elements = [
            ColumnLayout::get_object_data(
                ...
                [
                    ...
                    'background_image'       => [
                        'url'         => 'https://images.wpbrandy.com/uploads/o100ne-offer-1-bg.png',
                        'position'    => 'custom',
                        'x_position'  => 52,
                        'y_position'  => 50,
                        'repeat'      => 'no-repeat',
                            ...
                            [
                                'children' => [
                                    Image::get_object_data(
                                        [
                                            'src'     => 'https://images.wpbrandy.com/uploads/o100ne-offer-1-icon.png',
                                            'padding' => [
                                                'top'    => 0,
                                                'bottom' => 10,
                                                'right'  => 50,
                                    ...
                                    Text::get_object_data(
                                        [
                                            'background_color' => '#ffffff00',
                                            'text_color' => '#333439',
                                            'rich_text'  => '<p style="text-align: center; margin: 0;"><span style="font-size: 20px; font-weight: 700;"><b>Welcome to [o100_site_name]</b></span></p>',
                                            'padding'    => [
                                                'top'    => 15,
                                                'bottom' => 5,
                                                'right'  => 50,
