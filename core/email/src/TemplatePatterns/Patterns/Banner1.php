...
class Banner1 extends BasePattern {
    ...
    public function __construct() {
        ...
        $this->position = 10;
        $this->name     = __( 'Banner 1', 'order100' );
        $this->elements = [
            ColumnLayout::get_object_data(
                ...
                [
                    ...
                    'background_image'       => [
                        'url'        => 'https://images.wpbrandy.com/uploads/o100ne-banner-1-img-1.jpg',
                        'position'   => 'custom',
                        'x_position' => 100,
                        'y_position' => 0,
                        'size'       => 'contain',
                            ...
                            [
                                'children' => [
                                    Image::get_object_data(
                                        [
                                            'src'     => 'https://images.wpbrandy.com/uploads/o100ne-banner-1-img-2.jpg',
                                            'padding' => [
                                                'top'    => 0,
                                                'bottom' => 0,
                                                'left'   => 0,
