...
class Banner7 extends BasePattern {
    ...
    public function __construct() {
        ...
        $this->position = 70;
        $this->name     = __( 'Banner 7', 'order100' );
        $this->elements = [
            ColumnLayout::get_object_data(
                ...
                [
                    ...
                    'background_image'       => [
                        'url'        => 'https://images.wpbrandy.com/uploads/o100ne-banner-7-img-1.jpg',
                        'position'   => 'top_left',
                        'x_position' => 100,
                        'y_position' => 0,
                        'size'       => 'cover',
                            ...
                            [
                                'children' => [
                                    Image::get_object_data(
                                        [
                                            'src'     => 'https://images.wpbrandy.com/uploads/o100ne-banner-7-img-3.png',
                                            'padding' => [
                                                'top'    => 0,
                                                'bottom' => 0,
                                                'right'  => 0,
