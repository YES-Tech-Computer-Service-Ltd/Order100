...
class Shipping2 extends BasePattern {
    ...
    public function __construct() {
        ...
        $this->position = 11;
        $this->name     = __( 'Shipping 2', 'order100' );
        $this->elements = [
            ColumnLayout::get_object_data(
                ...
                [
                    ...
                    'background_image'       => [
                        'url'      => 'https://images.wpbrandy.com/uploads/o100ne-shipping-2-bg.png',
                        'position' => 'top_center',
                    ],
                    'children'               => [
                            ...
                            [
                                'children' => [
                                    Image::get_object_data(
                                        [
                                            'src'     => 'https://images.wpbrandy.com/uploads/o100ne-shipping-2-icon.png',
                                            'width'   => 159,
