        ...
        $this->elements = [
            ColumnLayout::get_object_data(
                ...
                [
                    ...
                    'background_image'       => [
                        'url'      => 'https://images.wpbrandy.com/uploads/o100ne-intro-5-bg.png',
                            ...
                            [
                                'children' => [
                                    Image::get_object_data(
                                        [
                                            'src'     => 'https://images.wpbrandy.com/uploads/o100ne-yay-logo-v2.png',
                                            'width'   => 221,
                                            'align'   => 'center',
                                            'padding' => [
                                                'top'    => 0,
            ...
            Text::get_object_data(
                [
                    'rich_text'        => '<p style="text-align: center; margin: 0; font-weight: 500;"><span style="font-size: 24px;">Welcome [o100_customer_name]! We\'re excited to unveil our latest product, meticulously crafted with you in mind!</span></p>',
                    'padding'          => [
                        'top'    => 40,
                        'right'  => 80,
                        'bottom' => 23,
