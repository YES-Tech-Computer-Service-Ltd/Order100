...
class Banner3 extends BasePattern {
    ...
    public function __construct() {
        ...
        $this->position = 30;
        $this->name     = __( 'Banner 3', 'order100' );
        $this->elements = [
            ColumnLayout::get_object_data(
                ...
                [
                    ...
                    'background_image'       => [
                        'url'        => 'https://images.wpbrandy.com/uploads/o100ne-banner-3-img-1-scaled.jpg',
                        'position'   => 'custom',
                        'x_position' => 100,
                        'y_position' => 0,
                        'size'       => 'cover',
                            ...
                            [
                                'children' => [
                                    Image::get_object_data(
                                        [
                                            'src'     => 'https://images.wpbrandy.com/uploads/o100ne-banner-3-img-4.png',
                                            'padding' => [
                                                'top'    => 10,
                                                'bottom' => 10,
                                                'right'  => 10,
                                    ...
                                    Text::get_object_data(
                                        [
                                            'rich_text'  => '<p style="display: flex; justify-content: center; font-size: 14px; margin: 0px;"><u>Explore Now</u> <span style="padding: 1px 0px 0px 5px;"> <img src="https://images.wpbrandy.com/uploads/o100ne-banner-img-arrow-1.png" style="width:20px !important; height:20px !important;" alt="arrow banner 3" width="12" height="12" /> </span></p>',
                                            'background_color' => '#ffffff00',
                                            'text_color' => '#333439',
                                            'padding'    => [
                                                'top'    => 10,
                                    ...
                                    Image::get_object_data(
                                        [
                                            'src'     => 'https://images.wpbrandy.com/uploads/o100ne-banner-3-img-2.png',
                                            'padding' => [
                                                'top'    => 10,
                                                'bottom' => 10,
                                                'right'  => 10,
