...
class Footer6 extends BasePattern {
    ...
    private function __construct() {
        ...
        $this->position = 60;
        $this->name     = __( 'Footer 6', 'order100' );
        $this->elements = [
                                            ...
                                            'rich_text'  => '<table role="presentation" cellspacing="0" cellpadding="0" border="0">
                                                <tr>
                                                    <td style="vertical-align: middle; padding-right: 8px;">
                                                        <img src="https://images.wpbrandy.com/uploads/o100ne-footer-img-5.png" alt="" width="30" height="30" />
                                                    </td>
                                    ...
                                    Text::get_object_data(
                                        [
                                            'rich_text'  => '<table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin: 0 10px;">
                                                <tr>
                                                    <td style="vertical-align: middle; padding-right: 8px;">
                                                     <img src="https://images.wpbrandy.com/uploads/o100ne-footer-img-6.png" alt="" width="30" height="30" />
                                                    </td>
                                                    <td style="vertical-align: middle; font-size: 16px;">
                                                     O100ne.com
                                                    </td>
