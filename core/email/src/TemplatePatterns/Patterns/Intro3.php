                                ...
                                'children' => [
                                    ...
                                    Text::get_object_data(
                                        [
                                            'background_color' => '#ffffff00',
                                            'text_color' => '#FFFFFF',
                                            'rich_text'  => '<p><a style="text-decoration: underline; font-size: 15px; font-weight: 500; color: #333439 !important; text-underline-offset: 4px;" href="[o100_site_url]">Shop Now <img style="margin-left: 3px; width: 12px;" src="https://images.wpbrandy.com/uploads/o100ne-offer-2-img.png" alt="arrow_right" /></a></p>',
                                            'padding'    => [
                                                'top'    => 25,
                                                'bottom' => 25,
                                                'right'  => 0,
                        ...
                        Column::get_object_data(
                            ...
                            [
                                'children' => [
                                    Image::get_object_data(
                                        [
                                            'src'     => 'https://images.wpbrandy.com/uploads/o100ne-intro-3-img.png',
                                            'padding' => [
                                                'top'    => 0,
                                                'bottom' => 0,
                                                'right'  => 0,
