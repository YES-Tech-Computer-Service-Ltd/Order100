...
class Gallery4 extends BasePattern {
    ...
    private function __construct() {
        ...
        $this->position = 13;
        $this->name     = __( 'Gallery 4', 'order100' );
        $this->elements = [
            Text::get_object_data(
                [
                    'background_color' => '#ffffff',
                    'text_color'       => '#242527',
                    'rich_text'        => '<p style="text-align: center; margin: 0;"><span style="font-size: 18px; font-weight: 600;">Discover Our Newest Collection at @[o100_site_name]</span></p>',
                    'padding'          => [
                        'top'    => 15,
                        'bottom' => 15,
                        'left'   => 30,
                            ...
                            [
                                'children' => [
                                    Image::get_object_data(
                                        [
                                            'src'     => 'https://images.wpbrandy.com/uploads/o100ne-gallery-4-img-1.png',
                                            'width'   => 107,
                                            'align'   => 'left',
                        ...
                        Column::get_object_data(
                            ...
                            [
                                'children' => [
                                    Image::get_object_data(
                                        [
                                            'src'     => 'https://images.wpbrandy.com/uploads/o100ne-gallery-4-img-2.png',
                                            'width'   => 360,
                                            'align'   => 'center',
                                            'background_color' => '#ffffff00',
                                            'padding' => [
                        ...
                        Column::get_object_data(
                            ...
                            [
                                'children' => [
                                    Image::get_object_data(
                                        [
                                            'src'     => 'https://images.wpbrandy.com/uploads/o100ne-gallery-4-img-3.png',
                                            'width'   => 107,
                                            'align'   => 'right',
                                            'background_color' => '#ffffff00',
                                            'padding' => [
