...
class Banner6 extends BasePattern {
    ...
    private function __construct() {
        ...
        $this->position = 60;
        $this->name     = __( 'Banner 6', 'order100' );
        $this->elements = [
            ColumnLayout::get_object_data(
                ...
                [
                    ...
                    'background_image'       => [
                        'url'        => 'https://images.wpbrandy.com/uploads/o100ne-banner-6-img-1.png',
                        'position'   => 'custom',
                        'x_position' => 100,
                        'y_position' => 0,
                        'size'       => 'cover',
                            ...
                            [
                                'children' => [
                                    Image::get_object_data(
                                        [
                                            'src'     => 'https://images.wpbrandy.com/uploads/o100ne-banner-6-img-2.png',
                                            'padding' => [
                                                'top'    => 40,
                                                'bottom' => 0,
                                                'right'  => 10,
