        ...
        $this->elements = [
            ColumnLayout::get_object_data(
                ...
                [
                    ...
                    'background_image'       => [
                        'url'        => 'https://images.wpbrandy.com/uploads/o100ne-offer-2-bg.png',
                                ...
                                'children' => [
                                    ...
                                    Text::get_object_data(
                                        [
                                            'background_color' => '#ffffff00',
                                            'text_color' => '#FFFFFF',
                                            'rich_text'  => '<p><span style="border: 1px dashed #ffffff59; border-radius: 10px; font-size: 15; font-weight: 500; text-align: center; width: fit-content; padding: 10px 15px; letter-spacing: 3px;">COUPON50F</span><a style="padding-left: 20px; text-decoration: underline; font-size: 15px; font-weight: 500; color: inherit; text-underline-offset: 4px;" href="#">Shop Now <img style="margin-left: 3px; width: 12px;" src="https://images.wpbrandy.com/uploads/o100ne-offer-2-img.png" alt="arrow_right" /></a></p>',
                                            'padding'    => [
                                                'top'    => 25,
                                                'bottom' => 25,
                                                'right'  => 5,
