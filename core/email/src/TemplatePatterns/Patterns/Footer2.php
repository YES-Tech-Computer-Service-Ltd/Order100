...
class Footer2 extends BasePattern {
    ...
    private function __construct() {
        ...
        $this->position = 11;
        $this->name     = __( 'Footer 2', 'order100' );
        $this->elements = [
            ...
            Text::get_object_data(
                [
                    'rich_text'  => '<p style="margin: 0px; text-align: center; font-weight: 300;"><span style="font-size: 14px; margin: 0;">© 2023 O100ne.com<br /></span><span style="font-size: 14px; text-align: center;">70 Washington Square South New York, NY 10012, United States</span></p>
