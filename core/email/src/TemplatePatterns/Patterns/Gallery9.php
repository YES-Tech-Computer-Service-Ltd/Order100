...
class Gallery9 extends BasePattern {
    ...
    private function __construct() {
        ...
        $this->position = 18;
        $this->name     = __( 'Gallery 9', 'order100' );
        $this->elements = [
                            ...
                            [
                                'children' => [
                                    Image::get_object_data(
                                        [
                                            'src'     => 'https://images.wpbrandy.com/uploads/o100ne-gallery-9-img-1.png',
                                            'width'   => 125,
                                            'align'   => 'center',
                                    ...
                                    Image::get_object_data(
                                        [
                                            'src'     => 'https://images.wpbrandy.com/uploads/o100ne-gallery-9-img-2.png',
                                            'width'   => 128,
                                            'align'   => 'center',
                                            'background_color' => '#ffffff00',
                                            'padding' => [
                        ...
                        Column::get_object_data(
                            ...
                            [
                                'children' => [
                                    Image::get_object_data(
                                        [
                                            'src'     => 'https://images.wpbrandy.com/uploads/o100ne-gallery-9-img-4.png',
                                            'width'   => 127,
                                            'align'   => 'center',
                                            'background_color' => '#ffffff00',
                                            'padding' => [
                                    ...
                                    Image::get_object_data(
                                        [
                                            'src'     => 'https://images.wpbrandy.com/uploads/o100ne-gallery-9-img-3.png',
                                            'width'   => 127,
                                            'align'   => 'center',
                                            'background_color' => '#ffffff00',
                                            'padding' => [
                        ...
                        Column::get_object_data(
                            ...
                            [
                                'children' => [
                                    Image::get_object_data(
                                        [
                                            'src'     => 'https://images.wpbrandy.com/uploads/o100ne-gallery-9-img-5.png',
                                            'width'   => 127,
                                            'align'   => 'center',
                                            'background_color' => '#ffffff00',
                                            'padding' => [
                                    ...
                                    Image::get_object_data(
                                        [
                                            'src'     => 'https://images.wpbrandy.com/uploads/o100ne-gallery-9-img-7.png',
                                            'width'   => 122,
                                            'align'   => 'center',
                                            'background_color' => '#ffffff00',
                                            'padding' => [
                        ...
                        Column::get_object_data(
                            ...
                            [
                                'children' => [
                                    Image::get_object_data(
                                        [
                                            'src'     => 'https://images.wpbrandy.com/uploads/o100ne-gallery-9-img-6.png',
                                            'width'   => 124,
                                            'align'   => 'center',
                                            'background_color' => '#ffffff00',
                                            'padding' => [
                                    ...
                                    Image::get_object_data(
                                        [
                                            'src'     => 'https://images.wpbrandy.com/uploads/o100ne-gallery-9-img-8.png',
                                            'width'   => 124,
                                            'align'   => 'center',
                                            'background_color' => '#ffffff00',
                                            'padding' => [
