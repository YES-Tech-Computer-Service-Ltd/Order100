...
use Order100\Notification\Engine\Elements\ImageList;
...
class Footer10 extends BasePattern {
    ...
    private function __construct() {
        ...
        $this->position = 100;
        $this->name     = __( 'Footer 10', 'order100' );
        $this->elements = [
                                ...
                                'children' => [
                                    ImageList::get_object_data(
                                        [
                                            ...
                                            'column_1' =>
                                            [
                                                'image'   => 'https://images.wpbrandy.com/uploads/o100ne-footer-2-img-1.png',
                                                'align'   => 'left',
                                                'width'   => 108,
                                                'padding' => [
                                                    'top'  => '10',
                                            ...
                                            'column_2' =>
                                            [
                                                'image'   => 'https://images.wpbrandy.com/uploads/o100ne-footer-2-img-2.png',
                                                'align'   => 'right',
                                                'width'   => 108,
                                                'padding' => [
                                                    'top'  => '10',
                        ...
                        Column::get_object_data(
                            ...
                            [
                                'children' => [
                                    ...
                                    Text::get_object_data(
                                        [
                                            'rich_text'  => '<p style="margin: 0px; text-align: left;"><span>Call us <u>+1345 678 900</u> or say hi at <u>hi@o100ne.com</u></span></p>',
                                            'padding'    => [
                                                'top'    => 0,
                                                'right'  => 0,
                                                'bottom' => 0,
