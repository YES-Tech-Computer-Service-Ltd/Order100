...
class AddonModel {
    ...
    public static function get_all() {
        $data = [
            'O100neAddonConditionalLogic'                 => [
                'plugin_name'  => 'O100ne Conditional Logic',
                'link_upgrade' => 'https://o100ne.com/o100ne-addons/conditional-logic-addon-for-o100ne/',
                ...
                'plugin_slug'  => 'o100ne-conditional-logic',
                'categories'   => [ 'marketing', 'others' ],
            ],
            'O100neAddonWcSubscription'                   => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-woocommerce-subscriptions',
                'is_3rd_party_installed' => class_exists( 'WC_Subscriptions' ),
                'plugin_slug'            => 'o100ne-premium-addon-for-woocommerce-subscription',
                'description'            => 'Customize <strong>WooCommerce Subscriptions</strong> emails with <strong>O100ne</strong> email builder.',
                'categories'             => [ 'subscription' ],
            ],
            'O100neAddonYITHWishlist'                     => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-yith-woocommerce-wishlist',
                'is_3rd_party_installed' => function_exists( 'yith_wishlist_constructor' ),
                'description'            => 'Use O100ne to customize your <strong>YITH WooCommerce Wishlist</strong>&nbsp;email templates.',
                'plugin_slug'            => 'o100ne-addon-for-yith-woocommerce-wishlist-premium',
                'categories'             => [ 'marketing', 'others' ],
            ],
            'O100neAddonSUMOSubscriptions'                => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-sumo-subscription',
                'is_3rd_party_installed' => class_exists( 'SUMOSubscriptions' ),
                'description'            => 'Use O100ne to customize the email templates of <strong>SUMO Subscriptions - WooCommerce Subscription System</strong>.',
                'plugin_slug'            => 'o100ne-addon-for-sumo-subscriptions',
                'categories'             => [ 'subscription' ],
            ],
            'O100neAddonYITHWooSubscription'              => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-yith-woocommerce-subscription',
                'is_3rd_party_installed' => function_exists( 'YITH_WC_Subscription' ),
                'description'            => 'HTML email design made simple. Now you can fully customize <strong>YITH WooCommerce Subscription</strong> emails with <strong>O100ne</strong>.',
                'plugin_slug'            => 'o100ne-addon-for-yith-subscription',
                'categories'             => [ 'subscription' ],
            ],
            'O100neAddonWcB2B'                            => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-woocommerce-b2b',
                ...
                'plugin_slug'            => 'o100ne-addon-for-wc-b2b',
            ...
            'O100neYithVendor'                            => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-yith-woocommerce-multi-vendor',
                'is_3rd_party_installed' => function_exists( 'YITH_Vendors' ),
                'description'            => 'Fully customize extra email templates sent by <strong>YITH WooCommerce Multi Vendor</strong>&nbsp;using the&nbsp;<strong>O100ne</strong>&nbsp;email designer.',
                'plugin_slug'            => 'o100ne-addon-for-yith-woocommerce-multi-vendor',
            ],
            'O100neAddonGermanized'                       => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-woocommerce-germanized',
                'is_3rd_party_installed' => class_exists( 'WooCommerce_Germanized' ),
                'description'            => 'Use <strong>O100ne</strong> to customize your WooCommerce <strong>Germanized</strong> email templates.',
                'plugin_slug'            => 'o100ne-addon-for-germanized',
                'categories'             => [ 'shipment', 'order-status', 'others' ],
            ],
            'O100neAddonWcBookings'                       => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-woocommerce-bookings',
                'is_3rd_party_installed' => class_exists( 'WC_Bookings' ),
                'description'            => 'Start customizing <strong>WooCommerce Bookings</strong> email templates with <strong>O100ne - WooCommerce Email Customizer</strong> today!',
                'plugin_slug'            => 'o100ne-addon-for-woocommerce-bookings',
                'categories'             => [ 'booking', 'subscription' ],
            ],
            'O100neAddonWcWaitlist'                       => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-woocommerce-waitlist',
                'is_3rd_party_installed' => class_exists( 'WooCommerce_Waitlist_Plugin' ),
                'description'            => 'Beautify <strong>WooCommerce Waitlist</strong> emails to lead to a better brand impression. Easy to use and set up using <strong>O100ne Builder</strong>.',
                'plugin_slug'            => 'o100ne-addon-for-woo-waitlist',
                'categories'             => [ 'others' ],
            ],
            'O100neAddonQuotesForWooCommerce'             => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-quotes-for-woocommerce',
                'is_3rd_party_installed' => class_exists( 'Quotes_WC' ),
                'description'            => 'Use O100ne to customize your <strong>Quotes for WooCommerce</strong> email templates (by Pinal Shah).',
                'plugin_slug'            => 'o100ne-addon-for-quotes-for-woocommerce',
                'categories'             => [ 'wholesale' ],
            ],
            'O100neAddonYITHPreOrder'                     => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-yith-woocommerce-pre-order',
                'is_3rd_party_installed' => function_exists( 'yith_ywpo_init' ),
                'description'            => 'Use O100ne to customize your <strong>YITH WooCommerce Pre-Order</strong> email templates.',
                'plugin_slug'            => 'o100ne-addon-for-yith-pre-order',
                'categories'             => [ 'order-status', 'others' ],
            ],
            'O100neAddonWCAppointments'                   => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-woocommerce-appointments',
                'is_3rd_party_installed' => class_exists( 'WC_Appointments' ),
                'description'            => 'Customize your <strong>WooCommerce Appointments</strong> emails with the <strong>O100ne</strong> email builder.',
                'plugin_slug'            => 'o100ne-addon-for-woocommerce-appointments',
                'categories'             => [ 'booking' ],
            ],
            'O100neAddonSGWcOrderApproval'                => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-sg-woocommerce-order-approval',
                'is_3rd_party_installed' => class_exists( 'Sgitsoa_Order_Approval_Woocommerce_Pro' ) || class_exists( 'Sg_Order_Approval_Woocommerce' ),
                'description'            => 'Customize SG WooCommerce <strong>Order Approval</strong> emails in <strong>O100ne</strong> - a drag and drop email builder for WooCommerce.',
                'plugin_slug'            => 'o100ne-addon-for-sg-order-approval',
            ...
            // 'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-woocommerce-follow-up-emails',
            // 'is_3rd_party_installed' => function_exists( 'FUE' ),
            // 'plugin_slug'            => 'o100ne-addon-for-woocommerce-follow-ups',
            // ],
            'O100neAddonOrderDeliveryDatePro'             => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-woocommerce-order-delivery-date',
                'is_3rd_party_installed' => class_exists( 'order_delivery_date' ) || class_exists( 'order_delivery_date_lite' ),
                'categories'             => [ 'order-status' ],
                'description'            => 'Customize your <strong>Order Delivery Date</strong> emails with the <strong>O100ne</strong> email builder.',
                'plugin_slug'            => 'o100ne-addon-for-order-delivery-date',
            ],
            'O100neAddonOrderCancellationEmailToCustomer' => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-order-cancellation-email-to-customer',
                'is_3rd_party_installed' => class_exists( 'KA_Custom_WC_Email' ),
                'description'            => 'Use O100ne to customize your <strong>Order Cancellation Email to Customer</strong> email templates.',
                'plugin_slug'            => 'o100ne-addon-for-order-cancel-customer',
                'categories'             => [ 'order-status' ],
            ],
            'O100neAddonWcSmartCoupons'                   => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-smart-coupons',
                ...
                'plugin_slug'            => 'o100ne-addon-for-smart-coupons',
            ...
            'O100neAddonDokan'                            => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-dokan',
                'is_3rd_party_installed' => class_exists( 'WeDevs_Dokan' ),
                'description'            => 'Use <strong>O100ne</strong> to customize your <strong>Dokan</strong> WooCommerce Multivendor Marketplace email templates.',
                'plugin_slug'            => 'o100ne-addon-for-dokan',
                'categories'             => [ 'multivendor' ],
            ],
            'O100neAddonGermanMarket'                     => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-german-market',
                'is_3rd_party_installed' => class_exists( 'Woocommerce_German_Market' ),
                'description'            => 'Use <strong>O100ne</strong> to customize your <strong>WooCommerce German Market</strong> email templates.',
                'plugin_slug'            => 'o100ne-addon-for-woocommerce-german-market',
                'categories'             => [ 'shipment', 'order-status', 'payments', 'others' ],
            ],
            'O100neAddonB2BWholesaleSuite'                => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-b2b-wholesale-suite',
                'is_3rd_party_installed' => class_exists( 'B2bwhs' ),
                'description'            => 'Use <strong>O100ne</strong> to customize your <strong>B2B &amp; Wholesale Suite</strong> by WebWizards&nbsp;email templates.',
                'plugin_slug'            => 'o100ne-addon-for-b2b-wholesale-suite',
                'categories'             => [ 'wholesale' ],
            ],
            'O100neAddonWcDeposits'                       => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-woocommerce-deposits',
                'is_3rd_party_installed' => class_exists( '\Webtomizer\WCDP\WC_Deposits' ),
                'description'            => 'Customize WooCommerce <strong>Deposits</strong> emails in <strong>O100ne</strong> – a drag and drop email builder for WooCommerce.',
                'plugin_slug'            => 'o100ne-addon-for-woocommerce-deposits',
                'categories'             => [ 'payments' ],
            ],
            'O100neAddonYITHWooBookingAndAppointment'     => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-yith-booking-and-appointment-for-woocommerce',
                'is_3rd_party_installed' => function_exists( 'yith_wcbk_init' ),
                'categories'             => [ 'booking' ],
                'plugin_slug'            => 'o100ne-addon-for-yith-booking-appointment',
            ],
            'O100neAddonPointsRewards'                    => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-points-and-rewards-for-woocommerce',
                'is_3rd_party_installed' => class_exists( 'Points_Rewards_For_Woocommerce' ),
                'description'            => 'Use O100ne to customize your <strong>Points and Rewards for WooCommerce</strong> email templates.',
                'plugin_slug'            => 'o100ne-addon-for-points-rewards',
                'categories'             => [ 'payments', 'marketing' ],
            ],
            'O100neAddonWcGiftCards'                      => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-woocommerce-gift-cards',
                'is_3rd_party_installed' => class_exists( 'WC_Gift_Cards' ),
                'description'            => 'Get this <strong>O100ne Addon</strong> to beautify the <strong>WooCommerce</strong> <strong>Gift Cards</strong> email templates.',
                'plugin_slug'            => 'o100ne-addon-for-woocommerce-gift-cards',
                'categories'             => [ 'marketing', 'others' ],
            ],
            'O100neAddonPWGC'                             => [
                ...
                'description'            => 'Customize <strong>PW WooCommerce Gift Cards</strong> emails in O100ne – a drag and drop email builder for WooCommerce. ',
                'plugin_slug'            => 'o100ne-addon-for-pw-woocommerce-gift-cards',
                'categories'             => [ 'marketing' ],
            ],
            'O100neAddonYITHWooGiftCards'                 => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-yith-woocommerce-gift-cards',
                ...
                'plugin_slug'            => 'o100ne-addon-for-yith-woocommerce-gift-card',
                'categories'             => [ 'order-status', 'marketing' ],
            ],
            'O100neAddonYITHWooMembership'                => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-yith-woocommerce-membership',
                'is_3rd_party_installed' => function_exists( 'yith_wcmbs_pr_init' ),
                'description'            => 'Beautify <strong>YITH WooCommerce Membership</strong> emails to lead to a better brand impression. Easy to use and set up using O100ne Builder.',
                'plugin_slug'            => 'o100ne-addon-yith-woocommerce-membership-premium',
                'categories'             => [ 'membership' ],
            ],
            'O100neAddonOrderDeliveryWc'                  => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-order-delivery-for-woocommerce',
                'is_3rd_party_installed' => class_exists( 'WC_Order_Delivery' ),
                'description'            => 'Use O100ne to customize your <strong>WooCommerce Order Delivery Date Pro</strong> email templates.',
                'plugin_slug'            => 'o100ne-addon-for-woocommerce-order-delivery',

            ],
            'O100neAddonWcSimpleAuctions'                 => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-woocommerce-simple-auction',
                'is_3rd_party_installed' => class_exists( 'WooCommerce_simple_auction' ),
                'description'            => 'Simply install this O100ne Addon to design <strong>WooCommerce Simple Auctions</strong> emails in a drag and drop email builder.',
                'plugin_slug'            => 'o100ne-addon-for-woocommerce-simple-auction',
                'categories'             => [ 'others' ],
            ],
            'O100neAddonWCVendors'                        => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-wcvendors',
                'is_3rd_party_installed' => class_exists( 'WC_Vendors' ),
                'description'            => 'Fully customize extra email templates sent by <strong>WC Vendors Marketplace</strong> using the <strong>O100ne</strong> email designer.',
                'plugin_slug'            => 'o100ne-addon-for-wc-vendors',
                'categories'             => [ 'multivendor' ],
            ],
            'O100neAddonWcPreOrders'                      => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-woocommerce-pre-order',
                'is_3rd_party_installed' => class_exists( 'WC_Pre_Orders' ),
                'description'            => 'Are you selling pre-order products using <strong>WooCommerce Pre-Orders</strong>? Download this <strong>O100ne Addon</strong> to customize the email notifications today!',
                'plugin_slug'            => 'o100ne-addon-for-woocommerce-pre-orders',
                'categories'             => [ 'order-status', 'payments', 'marketing', 'others' ],

            ],
            'O100neWooSplitOrders'                        => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-woocommerce-split-order',
                'is_3rd_party_installed' => function_exists( 'vibe_split_orders' ),
                'description'            => 'Use O100ne to customize your <strong>Split Orders by Vibe Agency</strong> WooCommerce email templates.',
                'plugin_slug'            => 'o100ne-addon-for-woocommerce-split-orders',
                'categories'             => [ 'shipment', 'order-status', 'others' ],
            ],
            'O100neAddonWPCrowdfunding'                   => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-wp-crowdfunding',
                'is_3rd_party_installed' => class_exists( '\WPCF_PRO\Init' ) || class_exists( '\WPCF\Crowdfunding' ),
                'description'            => 'Fully customize extra email templates created by <strong>WP Crowdfunding</strong> using the O100ne email designer.',
                'plugin_slug'            => 'o100ne-addon-for-wp-crowdfunding',
                'categories'             => [ 'others' ],
            ],
            'O100neAddonWcPIP'                            => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-woocommerce-print-invoices-packing-lists',
                'is_3rd_party_installed' => class_exists( 'WC_PIP' ),
                'description'            => 'Customize <strong>WooCommerce Print Invoices &amp; Packing Lists</strong> emails with <strong>O100ne</strong> – WooCommerce Email Customizer.',
                'plugin_slug'            => 'o100ne-addon-for-print-invoices-packing-lists',
                'categories'             => [ 'payments', 'others' ],
            ],
            'O100neAddonLicenseManagerWc'                 => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-license-manager',
                'is_3rd_party_installed' => class_exists( 'LicenseManagerForWooCommerce\\Main' ),
                'description'            => 'Use O100ne to customize email templates sent by <strong>License Manager for WooCommerce</strong>.',
                'plugin_slug'            => 'o100ne-addon-for-license-manager-for-wc',
                'categories'             => [ 'others' ],
            ],
            'O100neAddonWcAccountFunds'                   => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-account-funds',
                'is_3rd_party_installed' => class_exists( 'WC_Account_Funds' ),
                'description'            => 'Use O100ne to customize your <strong>Account Funds</strong> email notifications sent by Themesquad.',
                'plugin_slug'            => 'o100ne-addon-for-woocommerce-account-funds',
                'categories'             => [ 'payments', 'marketing' ],
            ],
            'O100neAddonAutomateWoo'                      => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-automatewoo',
                'is_3rd_party_installed' => class_exists( 'AutomateWoo_Loader' ),
                'description'            => 'Fully customize extra email templates created by <strong>AutomateWoo</strong> workflows using the <strong>O100ne</strong> email designer.',
                'plugin_slug'            => 'o100ne-addon-for-automatewoo',
                'categories'             => [ 'marketing' ],
            ],
            'O100neAddonSMFW'                             => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-shopmagic',
                'is_3rd_party_installed' => class_exists( 'WPDesk\ShopMagic\Workflow\Workflow' ),
                'description'            => 'Want to boost your conversion rate? Customize follow-up emails &amp; marketing automation with ShopMagic &amp; O100ne Addon!',
                'plugin_slug'            => 'o100ne-addon-for-shopmagic',
                'categories'             => [ 'booking', 'order-status', 'marketing' ],
            ],
            'O100neAddonWcStripePaymentGateway'           => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-woocommerce-stripe-payment-gateway',
                'is_3rd_party_installed' => class_exists( 'WC_Stripe' ),
                'description'            => 'Use <strong>O100ne</strong> to customize email templates sent by <strong>WooCommerce Stripe Payment Gateway</strong>.',
                'plugin_slug'            => 'o100ne-addon-for-woocommerce-stripe-gateway',
                'categories'             => [ 'payments' ],
            ],
            'O100neAddonYithStripePremium'                => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-yith-woocommerce-stripe',
                'is_3rd_party_installed' => function_exists( 'YITH_WCStripe' ),
                'description'            => 'Use O100ne to customize your <strong>YITH WooCommerce Stripe</strong> email notifications.',
                'plugin_slug'            => 'o100ne-addon-for-yith-woocommerce-stripe',
                'categories'             => [ 'payments' ],
            ],
            'O100neAddonWcfmMarketplace'                  => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-wcfm-marketplace',
                'is_3rd_party_installed' => class_exists( 'WCFMmp' ),
                'description'            => 'Customize WCFM Multivendor Marketplace emails in O100ne – a drag and drop email builder for WooCommerce.',
                'plugin_slug'            => 'o100ne-addon-for-wcfm-marketplace',
                'categories'             => [ 'multivendor' ],
            ],
            'O100neAddonWcMemberships'                    => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-woocommerce-memberships',
                'is_3rd_party_installed' => class_exists( 'WC_Memberships' ),
                'description'            => 'Customize your <strong>WooCommerce Memberships</strong> emails with the <strong>O100ne</strong> email builder. Sell more services and gain more members.',
                'plugin_slug'            => 'o100ne-addon-for-woo-memberships',
                'categories'             => [ 'membership' ],
            ],
            'O100neAddonWcTrackShip'                      => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-trackship-for-woocommerce',
                'is_3rd_party_installed' => class_exists( 'Trackship_For_Woocommerce' ),
                'description'            => 'Customize your <strong>TrackShip</strong> post-shipping workflow\'s email templates with O100ne!',
                'plugin_slug'            => 'o100ne-addon-for-trackship-woocommerce',
                'categories'             => [ 'order-status', 'others' ],
            ],
            // // TODO: Hold
            ...
            // ],
            // 'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-alidropship-woo-plugin',
            ...
            // 'plugin_slug'            => 'o100ne-addon-alidropship-woo-plugin',
            // 'categories'             => [ 'shipment', 'marketing' ],
            // ],
            'O100neYITHWooReviewDiscountsPremium'         => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-yith-review-for-discounts',
                'is_3rd_party_installed' => function_exists( 'YITH_WRFD' ),
                'description'            => 'Use <strong>O100ne</strong> to customize your <strong>YITH WooCommerce Review for Discounts</strong> email templates.',
                'plugin_slug'            => 'o100ne-addon-for-yith-woo-review-for-discounts-premium',
                'categories'             => [ 'marketing' ],
            ],
            'O100neAddonSUMOPaymentPlans'                 => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-premium-addon-for-sumo-payment-plans',
                'is_3rd_party_installed' => class_exists( 'SUMOPaymentPlans' ),
                'description'            => 'Fully customize extra email templates sent by <strong>SUMO WooCommerce Payment Plans</strong> – Deposits, Down Payments, Installments, Variable Payments using the O100ne email designer.',
                'plugin_slug'            => 'o100ne-addon-for-sumo-payment-plans',
                'categories'             => [ 'payments' ],
            ],
            'O100neAddonWcTeraWallet'                     => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-terawallet',
                'is_3rd_party_installed' => class_exists( 'WooWallet' ) || class_exists( 'Woo_Wallet' ),
                'description'            => 'Use <strong>O100ne</strong> to customize your <strong>TeraWallet</strong> WooCommerce email templates.',
                'plugin_slug'            => 'o100ne-addon-for-terawallet',
                'categories'             => [ 'payments', 'others' ],
            ],
            // TODO
            ...
            // ],
            // 'link_upgrade' => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-custom-fields-by-addify',
            // 'description'  => 'Use <strong>O100ne</strong> to customize your <strong>Custom Fields</strong> by Addify email templates.',
            // 'plugin_slug'  => 'o100ne-addon-for-custom-fields-addify',
            // 'categories'   => [ 'others' ],
            // ],
            'O100neAddonMultiLocationInventory'           => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-woocommerce-multi-warehouse-order-routing',
                'is_3rd_party_installed' => class_exists( 'MW_WHDependencies' ),
                'description'            => 'Use <strong>O100ne</strong> to customize your <strong>WooCommerce Multi Warehouse &amp; Order Routing</strong> email templates by woocommercewarehouses.com',
                'plugin_slug'            => 'o100ne-addon-for-woocommerce-multilocation-inventory-order-routing',
                'categories'             => [ 'shipment', 'order-status' ],
            ],
            'O100neAddonMultiVendorX'                     => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-wc-marketplace',
                'is_3rd_party_installed' => class_exists( 'WC_Dependencies_Product_Vendor' ),
                'description'            => 'Use O100ne to customize your <strong>MultiVendorX</strong> email templates of MultiVendor Marketplace Solution For WooCommerce (formerly known as WCMp by WC Marketplace).',
                'plugin_slug'            => 'o100ne-addon-for-multivendor-marketplace-solution',
                'categories'             => [ 'multivendor' ],
            ],
            'O100neAddonAffiliateWc'                      => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-affiliate-for-woocommerce',
                'is_3rd_party_installed' => class_exists( 'Affiliate_For_WooCommerce' ),
                'description'            => 'Customize affiliate email templates to run a successful affiliate program with <strong>O100ne</strong> for WooCommerce.',
                'plugin_slug'            => 'o100ne-addon-for-affiliate-for-woocommerce',
                'categories'             => [ 'marketing' ],
            ],
            'O100neAddonWooProductVendors'                => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-woocommerce-product-vendors',
                'is_3rd_party_installed' => class_exists( 'WC_Product_Vendors' ),
                'description'            => 'Use O100ne to customize your <strong>WooCommerce Product Vendors</strong>&nbsp;email templates.',
                'plugin_slug'            => 'o100ne-addon-for-woocommerce-product-vendors',
                'categories'             => [ 'multivendor' ],
            ],
            'O100neAddonBISN'                             => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-back-in-stock-notifications',
                'is_3rd_party_installed' => class_exists( 'WC_Back_In_Stock' ),
                'description'            => 'Use&nbsp;<strong>O100ne</strong> to customize the email templates sent by <strong>Back In Stock Notifications</strong> (by WooCommerce).',
                'plugin_slug'            => 'o100ne-addon-for-woo-back-in-stock-notifications',
                'categories'             => [ 'order-status', 'others' ],
            ],
            'O100neAddonWcReturnWarranty'                 => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-woocommerce-return-and-warranty',
                'is_3rd_party_installed' => class_exists( 'WC_Return_Warranty' ) || class_exists( 'WC_Return_Warranty_Pro' ),
                'description'            => 'Use <strong>O100ne</strong> to customize your <strong>WooCommerce Return and Warranty</strong> email templates (by chilidevs).',
                'plugin_slug'            => 'o100ne-addon-for-woo-return-warranty-pro',
            ...
            'O100neAddonB2BKing'                          => [
                ...
                'slug_name'              => 'b2bking',
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-b2bking',
                'is_3rd_party_installed' => class_exists( 'B2bking' ),
                'description'            => 'Use&nbsp;<strong>O100ne</strong> to customize your <strong>B2BKing</strong> (by WebWizards)&nbsp;email templates.',
                'plugin_slug'            => 'o100ne-addon-for-b2bking',
                'categories'             => [ 'wholesale' ],
            ],
            // Hold
            // 'Domina_Shipping'                              => [
            ...
            // ],
            // 'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-domina-shipping',
            ...
            // 'plugin_slug'            => 'o100ne-addon-domina-shipping',
            // ],
            'O100neAddonYITHWooDeliveryDate'              => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-yith-woocommerce-delivery-date',
                'is_3rd_party_installed' => function_exists( 'yith_delivery_date_init_plugin' ),
                'description'            => 'Edit email content and add attractive visuals to <strong>YITH WooCommerce Delivery Date</strong> emails with O100ne - WooCommerce Email Customizer.',
                'plugin_slug'            => 'o100ne-addon-for-yith-woo-delivery-date',
            ],
            'O100neAddonYITHAdvancedRefundSystem'         => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-yith-advanced-refund-system',
                'is_3rd_party_installed' => function_exists( 'yith_ywars_init' ),
                'description'            => 'Use O100ne to customize your <strong>YITH Advanced Refund System for WooCommerce</strong> email templates.',
                'plugin_slug'            => 'o100ne-addon-for-yith-advanced-refund-system-for-woocommerce',
                'categories'             => [ 'order-status', 'payments', 'others' ],
            ],
            'O100neAddonYITHWooAffiliates'                => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-yith-woocommerce-affiliates',
                'is_3rd_party_installed' => function_exists( 'yith_affiliates_constructor' ),
                'description'            => 'Use <strong>O100ne</strong> to customize your <strong>YITH WooCommerce Affiliates</strong> email templates and grow your store!',
                'plugin_slug'            => 'o100ne-addon-for-yith-woo-affiliates',
                'categories'             => [ 'marketing' ],
            ],
            'O100neAddonYITHWooAuctions'                  => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-yith-auctions-for-woocommerce',
                'is_3rd_party_installed' => function_exists( 'yith_wcact_init_premium' ),
                'description'            => 'Are you using <strong>YITH Auctions for WooCommerce</strong>? Buy this O100ne Addon to customize those auctions emails.',
                'plugin_slug'            => 'o100ne-addon-for-yith-auctions-for-woo',
                'categories'             => [ 'payments', 'marketing' ],
            ],
            'O100neAddonRMAReturnRefundExchange'          => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-rma-return-refund-and-exchange-for-woocommerce',
                'is_3rd_party_installed' => function_exists( 'define_woo_refund_and_exchange_lite_constants' ),
                'description'            => 'Use O100ne to customize extra email templates sent by <strong>RMA Return Refund and Exchange for WooCommerce</strong> (by WPSwings).',
                'plugin_slug'            => 'o100ne-addon-for-rma-return-refund-exchange-for-woo',
                'categories'             => [ 'order-status', 'marketing', 'others' ],
            ],
            'O100neAddonYITHWooPointsRewards'             => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-yith-points-and-rewards',
                'is_3rd_party_installed' => function_exists( 'yith_ywpar_premium_constructor' ),
                'description'            => 'Fully customize extra email templates developed by <strong>YITH WooCommerce Points and Rewards</strong> using the <strong>O100ne</strong> email customizer.',
                'plugin_slug'            => 'o100ne-addon-for-yith-woo-points-rewards-premium',
            ],
            'O100neAddonWCPDFProductVouchers'             => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-woocommerce-pdf-product-vouchers',
                'is_3rd_party_installed' => class_exists( 'WC_PDF_Product_Vouchers' ),
                'description'            => 'Fully customize extra email templates sent by<strong> WooCommerce PDF Product Vouchers</strong>&nbsp;using&nbsp;<strong>O100ne</strong>&nbsp;email designer.',
                'plugin_slug'            => 'o100ne-addon-for-woo-pdf-product-vouchers',
            ],
            'O100neAddonYITHWooRequestAQuote'             => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-yith-woocommerce-request-a-quote',
                'is_3rd_party_installed' => function_exists( 'yith_ywraq_premium_constructor' ),
                'description'            => 'Fully customize extra email templates created by<strong> YITH WooCommerce Request a Quote</strong> using <strong>O100ne</strong> email designer.',
                'plugin_slug'            => 'o100ne-addon-for-yith-woo-request-a-quote',
                'categories'             => [ 'wholesale', 'others' ],
            ],
            'O100neAddonWooSellServices'                  => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-woo-sell-services',
                'is_3rd_party_installed' => class_exists( 'Woo_Sell_Services_Main' ),
                'description'            => 'Customize your <strong>Woo Sell Services</strong> email templates with the O100ne email designer.',
                'plugin_slug'            => 'o100ne-addon-for-woo-sell-services',
                'categories'             => [ 'booking', 'subscription', 'multivendor' ],
            ],
            'O100neAddonYITHWooRecoverAbandonedCart'      => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-yith-woocommerce-recover-abandoned-cart',
                'is_3rd_party_installed' => function_exists( 'yith_ywrac_premium_constructor' ),
                'description'            => 'Use <strong>O100ne</strong> designer to customize your extra email templates created by <strong>YITH WooCommerce Recover Abandoned Cart</strong>.',
                'plugin_slug'            => 'o100ne-addon-for-yith-woo-recover-abandoned-cart',
            ],
            'O100neAddonYITHWooCouponEmailSystem'         => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-yith-woocommerce-coupon-email-system',
                'is_3rd_party_installed' => function_exists( 'ywces_init' ),
                'description'            => 'Are you using <strong>YITH WooCommerce Coupon Email System</strong>? Buy this O100ne Addon to customize those coupon notification emails.',
                'plugin_slug'            => 'o100ne-addon-for-yith-woocommerce-coupon-email-system-premium',
                'categories'             => [ 'marketing' ],
            ],
            'O100neAddonYITHWooEasyLoginAndRegisterPopup' => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-yith-easy-login-register-popup',
                ...
                'plugin_slug'            => 'o100ne-addon-for-yith-easy-login-register-popup',
                'categories'             => [ 'others' ],
            ],
            'O100neAddonColissimoShippingMethod'          => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-colissimo-shipping-methods',
                'is_3rd_party_installed' => class_exists( 'LpcInit' ),
                'description'            => 'Customize WooCommerce <strong>Colissimo</strong> emails in <strong>O100ne</strong> – a drag and drop email builder for WooCommerce.',
                'plugin_slug'            => 'o100ne-addon-for-colissimo-shipping-methods-for-woo',
                'categories'             => [ 'shipment' ],
            ],
            'O100neAddonParcelPanelOrderTrackingWc'       => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-parcelpanel-order-tracking-for-woocommerce/',
                'is_3rd_party_installed' => class_exists( 'ParcelPanel\ParcelPanel' ),
                'description'            => 'Personalize WooCommerce shipment tracking emails to your customers using <strong>O100ne - WooCommerce Email Customizer</strong>!',
                'plugin_slug'            => 'o100ne-addon-for-parcel-panel-order-tracking',
                'categories'             => [ 'shipment' ],
            ],
            'O100neAddonWcCartAbandonmentRecovery'        => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-woo-cart-abandonment-recovery-cartflows',
                ...
                'plugin_slug'            => 'o100ne-addon-for-wc-cart-abandonment-recovery',
                'categories'             => [ 'marketing' ],
            ],
            'O100neAddonB2BMarket'                        => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-b2b-market-marketpress',
                ...
                'plugin_slug'            => 'o100ne-addon-for-b2b-market',
                'categories'             => [ 'wholesale' ],
            ],
            'O100neAddonWholesaleX'                       => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-wholesalex',
                'is_3rd_party_installed' => function_exists( 'wholesalex_run' ),
                'description'            => 'Customize WooCommerce B2B store order emails from <strong>WholesaleX</strong>&nbsp;with O100ne - WooCommerce Email Customizer.',
                'plugin_slug'            => 'o100ne-addon-for-wholesalex',
                'categories'             => [ 'wholesale' ],
            ],
            'O100neAddonWcBookingsAppointments'           => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-woocommerce-booking-and-appointments-pluginhive',
                ...
                'plugin_slug'            => 'o100ne-addon-for-woocommerce-booking-and-appointments-pluginhive',
                'categories'             => [ 'booking' ],
            ],
            'O100neAddonWcContactShippingQuote'           => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-woocommerce-contact-for-shipping-quote',
                ...
                'plugin_slug'            => 'o100ne-addon-for-woocommerce-contact-for-shipping-quote',
                'categories'             => [ 'shipment', 'wholesale' ],
            ],
            'O100neAddonDepositsPartialPayment'           => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-woocommerce-deposits-partial-payments-acowebs/',
                'is_3rd_party_installed' => class_exists( 'AWCDP_Deposits' ),
                'categories'             => [ 'payments' ],
                'plugin_slug'            => 'o100ne-addon-for-woocommerce-deposits-partial-payments-acowebs',
            ],
            'O100neAddonMarketKing'                       => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-marketking-multivendor-marketplace-plugin',
                ...
                'plugin_slug'            => 'o100ne-addon-for-marketking-multivendor-marketplace-plugin',
            ],
            'O100neAddonAddifyRegistrationFields'         => [
                ...
                'link_upgrade'           => 'https://o100ne.com/o100ne-addons/o100ne-addon-for-custom-user-registration-fields-for-woocommerce-by-addify/',
                'is_3rd_party_installed' => class_exists( 'Addify_Registration_Fields_Addon' ),
                'description'            => 'Customize <strong>Custom User Registration Fields for WooCommerce</strong> emails with <strong>O100ne</strong> email builder.',
                'plugin_slug'            => 'o100ne-addon-for-custom-user-registration-fields-addify',
                'categories'             => [ 'others' ],
            ],
        ];
    ...
    public static function get_shopmagic_template_ids() {
        if ( ! class_exists( 'O100neAddonSMFW\Emails\EmailsCreation' ) ) {
            return [];
        }

        $emails = \O100neAddonSMFW\Emails\EmailsCreation::get_instance()->get_emails();
    ...
    public static function get_wc_cart_abandonment_recovery_template_ids() {
        if ( ! class_exists( 'O100neAddonWcCartAbandonmentRecovery\EmailCreation' ) ) {
            return [];
        }
        $emails = \O100neAddonWcCartAbandonmentRecovery\EmailCreation::get_instance()->get_emails();
