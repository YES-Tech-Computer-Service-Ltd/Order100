<?php
    ...
    $license     = new \Order100\Notification\Engine\License\License( 'order100' );
?>
<div class="o100ne-license-card" id="<?php echo esc_attr( "{$plugin_slug}_license_card" ); ?>" style="<?php echo esc_attr( $is_addon ? 'order: 999;' : 'order: ' . O100NE_MENU_ORDER . ';' ); ?>">
    ...
    <div class="o100ne-license-card-body">
        ...
        <div class="o100ne-license-input-row">
            <input autocomplete="new-password" class="o100ne-license-input" type="password" id="<?php echo esc_attr( "{$plugin_slug}_license_input" ); ?>" value="" />
            <button class="button-primary o100ne-activate-license-button"  id="<?php echo esc_attr( "{$plugin_slug}_activate_button" ); ?>" data-plugin="<?php echo esc_attr( $plugin_slug ); ?>">
