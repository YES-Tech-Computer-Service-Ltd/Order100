        ...
        $default_elements = ElementsLoader::load_elements(
            [
                ...
                [
                    'type'       => 'Text',
                    'attributes' => [
                        'rich_text' => '<p><span>' . $email_hi . '</span></p><p><span>' . $email_text . '</span></p><p style=\"margin: 0px; padding-left: 40px;\"><span> [o100_customer_note]</span></p><p><span>' . $email_text_1 . '</span></p>',
                    ],
                ],
                [
                    'type' => 'OrderDetails',
