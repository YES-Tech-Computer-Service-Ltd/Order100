...
class NewOrder extends BaseEmail {
    ...
    public function get_default_elements() {
        ...
        $email_text      = sprintf( esc_html__( 'You’ve received the following order from %s:', 'woocommerce' ), '[o100_billing_first_name] [o100_billing_last_name]' );
    ...
    public function get_template_path() {
        return o100ne_get_template( 'emails/admin-new-order.php', '', O100NE_PLUGIN_PATH . 'templates/' );
    }
}
