...
class CustomerNewAccount extends BaseEmail {
    ...
    protected function __construct() {
        ...
        add_filter( 'o100_trigger_to_preview_email', [ $this, 'trigger_to_preview_email' ], 10, 3 );
        $this->maybe_disable_block_email_editor();
    }

    public function trigger_to_preview_email( $is_permitted, $email, $order_id ) {
        if ( $email->id === $this->id ) {
            add_action( 'o100_trigger_email', [ $this, 'trigger_email' ], 10, 2 );
            $is_permitted = true;
        }
        return $is_permitted;
    }
    ...
    public function get_default_elements() {
        ...
        $email_text        = sprintf( esc_html__( 'Thanks for creating an account on %1$s. Your username is %2$s. You can access your account area to view orders, change your password, and more at: %3$s', 'woocommerce' ), '[o100_site_name]', '<strong>[o100_customer_username]</strong>', '[o100_user_account_url]' );
        $email_text_1      = __( 'We look forward to seeing you soon.', 'woocommerce' );
        $password_generate = '[o100_set_password_link]';
        ...
        $default_elements = ElementsLoader::load_elements(
            [
                ...
                [
                    'type'       => 'Heading',
                    'attributes' => [
                        'rich_text' => $email_title . '[o100_site_name]',
                    ],
                ],
                [
                    'type'       => 'Text',
    ...
    public function get_template_path() {
        return o100ne_get_template( 'emails/customer-new-account.php', '', O100NE_PLUGIN_PATH . 'templates/' );
    }
}
