...
class CustomerCancelledOrder extends BaseEmail {
    ...
    public function get_default_elements() {
        ...
        $email_text      = sprintf( esc_html__( 'We’re getting in touch to let you know that your order #%1$s has been cancelled.', 'woocommerce' ), '[o100_order_number is_plain="true"]' );
    ...
    public function get_template_path() {
        return o100ne_get_template( 'emails/customer-cancelled-order.php', '', O100NE_PLUGIN_PATH . 'templates/' );
    }
}
