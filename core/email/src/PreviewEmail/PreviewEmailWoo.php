...
class PreviewEmailWoo {
    ...
    public static function email_preview_output( $order_id, $email_id, $email_address = '' ) {
        ...
        $template_data = new O100neTemplate( $email_id );
        ...
        add_filter( 'o100_is_preview_email', '__return_true' );
        ...
        if ( in_array( $email_id, $supported_template_ids, true ) ) {
            ...
            $content               = o100ne_get_content( '/templates/preview-email/notice.php', [ 'template_data' => $template_data ] );
            $is_disabled_send_mail = true;
        }
    ...
    public static function get_email_title_by_id( $email_id ) {
        ...
        return __( 'Email Subject', 'order100' );
    }
    ...
    private static function render_default_preview( $current_email, $email_class, $order ) {
        ...
        try {
            ...
            ob_end_clean();
            $content               = o100ne_get_content( '/templates/preview-email/notice.php' );
            $is_disabled_send_mail = true;
        }
    ...
    private static function trigger_email( $email_class, $email, $order_id ) {
        try {
            /**
             * Filter: o100ne_trigger_to_preview_email
             *
             ...
             *
             * @return bool True to use custom trigger via 'o100_trigger_email' action, false to use default WooCommerce trigger
             */
            if ( apply_filters( 'o100_trigger_to_preview_email', false, $email, $order_id ) ) {
                /**
                 * Action: o100ne_trigger_email
                 *
                 ...
                 * @param int    $order_id    The order ID
                 */
                do_action( 'o100_trigger_email', $email, $order_id );
            } else {
