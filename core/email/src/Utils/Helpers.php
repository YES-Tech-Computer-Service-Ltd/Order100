...
class Helpers {
    ...
    public static function is_o100ne_email( $template_name ) {
    ...
    public static function is_woocommerce_order( $order ) {
        ...
        return apply_filters( 'o100_is_woocommerce_order', $is_wc_order, $order );
    }
    ...
    public static function get_dummy_order( $order_status = \Automattic\WooCommerce\Enums\OrderStatus::COMPLETED ) {
        ...
        $product->set_name( __( 'Happy O100ne', 'order100' ) );
     ...
     */
    public static function o100ne_get_url_email_setting_page( $email_id ) {
