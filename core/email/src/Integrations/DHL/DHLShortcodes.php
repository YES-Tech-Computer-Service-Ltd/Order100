...
class DHLShortcodes extends BaseShortcode {
    ...
    public function get_shortcodes() {
        $shortcodes   = [];
        $shortcodes[] = [
            'name'        => 'o100_dhl_tracking_number',
            'description' => __( 'DHL Tracking Number', 'order100' ),
            'group'       => 'order_details',
            'callback'    => [ $this, 'o100_dhl_tracking_number' ],
        ];
        return $shortcodes;
    }

    public function o100ne_dhl_tracking_number( $data ) {
