...
abstract class AbstractMigration {
    ...
    const BACKUP_PREFIX         = '_o100ne_backup_';
    const SUCCESSFUL_MIGRATIONS = '_o100ne_successful_migrations';
    /**
    ...
    protected function backup() {
        ...
        $backup_data = apply_filters( 'o100_migration_backup_data', $backup_data );
        /** ****************************** */
        ...
        if ( ! $backup_response ) {
            ...
            throw new \Exception( 'O100ne failed to save backup option' );
        }
    ...
    protected function may_mark_template_as_v4_supported( string $template_post_id, $migration_manager = null ): void {
        ...
        $template_name = get_post_meta( $template_post_id, O100neTemplate::META_KEYS['name'], true );

        if ( in_array( $template_name, $supported_template_ids, true ) ) {
            update_post_meta( $template_post_id, O100neTemplate::META_KEYS['is_v4_supported'], true );
        }
    }
}
