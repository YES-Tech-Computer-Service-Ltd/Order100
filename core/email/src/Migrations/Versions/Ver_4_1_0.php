...
final class Ver_4_1_0 extends AbstractMigration {
    ...
    private function migrate_templates() {
        ...
        $default_template_global_header_settings = O100neTemplate::DEFAULT_DATA['global_header_settings'];
        $default_template_global_footer_settings = O100neTemplate::DEFAULT_DATA['global_footer_settings'];
        ...
        foreach ( $template_posts  as $template ) {
            ...
            $elements = get_post_meta( $template->ID, O100neTemplate::META_KEYS['elements'], true );
            ...
            $template_global_header_settings         = get_post_meta( $template->ID, O100neTemplate::META_KEYS['global_header_settings'], true );
            $template_global_footer_settings         = get_post_meta( $template->ID, O100neTemplate::META_KEYS['global_footer_settings'], true );
            ...
            update_post_meta( $template->ID, O100neTemplate::META_KEYS['global_header_settings'], $template_global_header_settings );
            update_post_meta( $template->ID, O100neTemplate::META_KEYS['global_footer_settings'], $template_global_footer_settings );
        ...
        if ( $has_global_header_foter_in_templates ) {
            ...
            foreach ( $templates_need_to_hide_header as $template_id ) {
                ...
                update_post_meta( $template_id, O100neTemplate::META_KEYS['global_header_settings'], $template_global_header_settings );
            }
            foreach ( $templates_need_to_hide_footer as $template_id ) {
                ...
                update_post_meta( $template_id, O100neTemplate::META_KEYS['global_footer_settings'], $template_global_footer_settings );
            }
        }//end if
