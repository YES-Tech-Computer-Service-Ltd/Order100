...
class ResetPasswordsShortcodes extends BaseShortcode {
    ...
    public function get_shortcodes() {
        $shortcodes[] = [
            ...
            'callback'    => [ $this, 'o100_password_reset_link' ],
        ];
        $shortcodes[] = [
            'name'        => 'o100_password_reset_url',
            'description' => __( 'Password Reset URL (String)', 'order100' ),
            'group'       => 'reset_passwords',
            'callback'    => [ $this, 'o100_password_reset_url' ],
        ];
        $shortcodes[] = [
            'name'        => 'o100_wp_password_reset_url',
            'description' => __( 'Password Reset URL by WP', 'order100' ),
            'group'       => 'reset_passwords',
            'callback'    => [ $this, 'o100_wp_password_reset_url' ],
        ];
        return $shortcodes;
    }
    ...
    public function o100ne_password_reset_url( $data ) {
    ...
    public function o100ne_wp_password_reset_url( $data ) {
