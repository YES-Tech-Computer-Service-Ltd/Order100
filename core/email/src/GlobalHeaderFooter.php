...
class GlobalHeaderFooter {
     ...
     *
     * @param string|O100neTemplate $template
     *
     * @return array
     */
     ...
     * @param string|O100neTemplate $template
     *
     * @return O100neTemplate|null
     */
    private static function get_template_from_input( $template ) {

        if ( is_string( $template ) ) {
            $template = new O100neTemplate( $template );
        }
    ...
    public static function get_global_header_override_heading_content( $template ) {
        ...
        return $global_header_settings['heading_content'] ?? O100neTemplate::DEFAULT_DATA['global_header_settings']['heading_content'];
    }
    ...
    public static function get_global_footer_override_content( $template ) {
        ...
        return $global_footer_settings['footer_content'] ?? O100neTemplate::DEFAULT_DATA['global_footer_settings']['footer_content'];
    }
    ...
    public static function is_global_header_footer_enabled() {
        return o100ne_settings()['global_header_footer_enabled'] ?? false;
    }
}
