  ...
  jQuery.ajax({
    ...
    success: function (response) {
      if (response.success === true) {
        ...
        jQuery('.yay-recommended-plugins-layout .plugin-install-tab').removeClass(
          'loading-process',
        );
      }
    },
    ...
    success: function (response) {
      if (response.success === true) {
        const pluginStatus = jQuery(
          ".yay-recommended-plugins-layout .plugin-status-inactive[data-plugin-file='" +
            file +
            "']",
        );
  ...
  jQuery.ajax({
    ...
    success: function (response) {
      if (response.success === true) {
        ...
        setTimeout(() => {
          const pluginStatus = jQuery(
            ".yay-recommended-plugins-layout .plugin-status-not-install[data-plugin-url='" +
              plugin +
              "']",
          );
          pluginStatus.text('Active');
