        ...
        return [
            ...
            'data'            => [
                ...
                'products'                => [
                    ...
                    'title'         => __( 'Select products', 'order100' ),
                ...
                'max_reviews_per_product' => [
                    ...
                    'title'         => __( 'Maximum reviews per product', 'order100' ),
                ...
                'reviews_per_row'         => [
                    ...
                    'component'     => 'NumberInput',
                    'title'         => __( 'Reviews per row', 'order100' ),
                ...
                'minimum_rating_to_show'  => [
                    ...
                    'component'     => 'NumberInput',
                    'title'         => __( 'Minimum rating', 'order100' ),
                ...
                'showing_items'           => [
                    ...
                    'options'       => [
                        [
                            'label' => __( 'Author avatar', 'order100' ),
                            'value' => 'author_avatar',
                        ],
                        [
                            'label' => __( 'Author name', 'order100' ),
                            'value' => 'author_name',
                        ],
                        [
                            'label' => __( 'Review date', 'order100' ),
                            'value' => 'review_date',
                        ],
                        [
                            'label' => __( 'Rating stars', 'order100' ),
                            'value' => 'rating_stars',
                        ],
                        [
                            'label' => __( 'Review message', 'order100' ),
                ...
                'sorted_by'               => [
                    ...
                    'component'     => 'Selector',
                    'title'         => __( 'Sort by', 'order100' ),
                    'default_value' => isset( $attributes['sorted_by'] ) ? $attributes['sorted_by'] : 'des_of_rating',
                    'options'       => [
                        [
                            'label' => __( 'Descending by rating', 'order100' ),
                            'value' => 'des_of_rating',
                        ],
                        [
                            'label' => __( 'Ascending by rating', 'order100' ),
                            'value' => 'asc_of_rating',
                        ],
                        [
                            'label' => __( 'Descending by review date', 'order100' ),
                            'value' => 'des_of_review_date',
                        ],
                        [
                            'label' => __( 'Ascending by review date', 'order100' ),
