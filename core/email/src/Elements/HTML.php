        ...
        return [
            ...
            'data'      => [
                'rich_text' => [
                    ...
                    'component'     => 'TextInput',
                    'title'         => __( 'HTML code', 'order100' ),
                    'default_value' => isset( $attributes['rich_text'] ) ? $attributes['rich_text'] : '<div>Welcome to[o100_site_name]</div>',
                    'placeholder'   => __( 'Import HTML code', 'order100' ),
                    'multiple'      => true,
                    'rows'          => 10,
                    'type'          => 'content',
                ],
