...
';
        ...
        return [
            'id'              => uniqid(),
            'type'            => self::$type,
            'name'            => __( 'Container', 'order100' ),
            'icon'            => self::$icon,
            'group'           => 'general',
            'available'       => false,
            'disabled_reason' => [
                'html' => __( 'This element is available in O100ne Pro', 'order100' ),
            ],
            'position'        => 145,
            ...
            'data'            => [
                ...
                'direction'        => [
                    ...
                    'component'     => 'Selector',
                    'title'         => __( 'Direction', 'order100' ),
                    'default_value' => isset( $attributes['direction'] ) ? $attributes['direction'] : 'horizontal',
                    'options'       => [
                        [
                            'label' => __( 'Horizontal', 'order100' ),
                            'value' => 'horizontal',
                        ],
                        [
                            'label' => __( 'Vertical', 'order100' ),
                            'value' => 'vertical',
                        ],
                    ],
                    'type'          => 'style',
