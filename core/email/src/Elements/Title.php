        ...
        return [
            ...
            'data'      => [
                ...
                'title_group_definition'     => [
                    'component'   => 'GroupDefinition',
                    'title'       => __( 'Title settings', 'order100' ),
                    'description' => __( 'Handle title settings', 'order100' ),
                ],
                'title'                      => [
                    'value_path'    => 'title',
                    'component'     => 'TextInput',
                    'title'         => __( 'Text', 'order100' ),
                    'default_value' => isset( $attributes['title'] ) ? $attributes['title'] : __( 'Enter your title here', 'order100' ),
                    'type'          => 'content',
                ],
                'title_size'                 => [
                    'value_path'    => 'title_size',
                    'component'     => 'FontSizeSelector',
                    'title'         => __( 'Font size', 'order100' ),
                ...
                'subtitle_group_definition'  => [
                    'component'   => 'GroupDefinition',
                    'title'       => __( 'Subtitle settings', 'order100' ),
                    'description' => __( 'Handle subtitle settings', 'order100' ),
                ],
                'subtitle'                   => [
                    'value_path'    => 'subtitle',
                    'component'     => 'TextInput',
                    'title'         => __( 'Text', 'order100' ),
                    'default_value' => isset( $attributes['subtitle'] ) ? $attributes['subtitle'] : __( 'Subtitle', 'order100' ),
                    'type'          => 'content',
                ],
                'subtitle_size'              => [
