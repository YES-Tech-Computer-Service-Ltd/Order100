        ...
        return [
            ...
            'data'            => [
                ...
                'border_group_definition'  => [
                    ...
                    'description' => __( 'Handle content border settings', 'order100' ),
                    'conditions'  => $border_conditions,
                ],
                'border_width'             => [
                    'value_path'    => 'border_width',
                    'component'     => 'NumberInput',
                    'title'         => __( 'Border width', 'order100' ),
                ...
                'border_style'             => [
                    ...
                    'component'     => 'Selector',
                    'title'         => __( 'Border style', 'order100' ),
