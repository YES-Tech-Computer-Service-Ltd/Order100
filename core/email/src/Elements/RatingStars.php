        ...
        return [
            ...
            'data'        => [
                ...
                'active_stars'               => [
                    ...
                    'component'      => 'NumberInput',
                    'title'          => __( 'Active stars', 'order100' ),
                ...
                'active_stars_color'         => ElementsHelper::get_color(
                    $attributes,
                    [
                        'title'         => __( 'Active color', 'order100' ),
                        'description'   => __( 'The color of the active stars', 'order100' ),
                ...
                'inactive_stars_color'       => ElementsHelper::get_color(
                    $attributes,
                    [
                        'title'         => __( 'Inactive color', 'order100' ),
                        'description'   => __( 'The color of the inactive stars', 'order100' ),
