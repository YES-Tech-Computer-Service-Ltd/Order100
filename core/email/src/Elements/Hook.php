        ...
        return [
            ...
            'data'      => [
                ...
                'hook_shortcode'   => [
                    ...
                    'title'         => __( 'Hook shortcode', 'order100' ),
                    'default_value' => isset( $attributes['rich_text'] ) ? $attributes['hook_shortcode'] : '[o100_custom_hook hook="woocommerce_email_before_order_table"]',
                    'type'          => 'content',
                ],
                'font_family'      => [
