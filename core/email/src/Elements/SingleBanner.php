        ...
        return [
            ...
            'data'            => [
                ...
                'content_width'               => [
                    ...
                    'component'     => 'Dimension',
                    'title'         => __( 'Content width', 'order100' ),
                ...
                'content_align'               => [
                    ...
                    'component'     => 'Align',
                    'title'         => __( 'Content align', 'order100' ),
                ...
                'showing_items'               => [
                    ...
                    'options'       => [
                        [
                            'label' => __( 'Background image', 'order100' ),
                            'value' => 'background_image',
                        ],
                        [
                            'label' => __( 'Button', 'order100' ),
                            'value' => 'button',
                        ],
                    ],
                ],
                ...
                'background_group_definition' => [
                    'component'   => 'GroupDefinition',
                    'title'       => __( 'Background', 'order100' ),
                    'description' => __( 'Handle background settings', 'order100' ),
                    'conditions'  => $background_conditions,
                ],
                'background_image'            => [
                    'value_path'    => 'background_image',
                    'component'     => 'BackgroundImage',
                    'title'         => __( 'Background image', 'order100' ),
                    'default_value' => isset( $attributes['background_image'] ) ? $attributes['background_image'] : [
                        'url'        => O100NE_PLUGIN_URL . 'assets/images/shopping-image.jpeg',
                ...
                'button_group_definition'     => [
                    ...
                    'description' => __( 'Handle button settings', 'order100' ),
                    'conditions'  => $button_conditions,
                ],
                'button_text'                 => [
                    'value_path'    => 'button_text',
                    'component'     => 'TextInput',
                    'title'         => __( 'Button text', 'order100' ),
                    'default_value' => isset( $attributes['button_text'] ) ? $attributes['button_text'] : __( 'ORDER NOW', 'order100' ),
                    'type'          => 'content',
                    'conditions'    => $button_conditions,
                ],
                'button_url'                  => [
                ...
                'button_align'                => [
                    ...
                    'component'     => 'Align',
                    'title'         => __( 'Button align', 'order100' ),
                ...
                'button_background_color'     => [
                    ...
                    'component'     => 'Color',
                    'title'         => __( 'Button background color', 'order100' ),
