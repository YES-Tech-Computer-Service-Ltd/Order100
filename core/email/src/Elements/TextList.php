        ...
        return [
            ...
            'data'      => [
                ...
                'number_column'              => [
                    ...
                    'title'         => __( 'Number of columns:', 'order100' ),
                ...
                'text_list'                  => [
                    ...
                    'column_1'   => [
                        ...
                        'font_family'             => [
                            'value' => isset( $attributes['column_1']['font_family'] ) ? $attributes['column_1']['font_family'] : O100NE_DEFAULT_FAMILY,
                            'type'  => 'style',
                        ],
                        ...
                        'button_text'             => [
                            'value' => isset( $attributes['column_1']['button_text'] ) ? $attributes['column_1']['button_text'] : __( 'Click me', 'order100' ),
                            'type'  => 'content',
                        ],
                        ...
                        'button_background_color' => [
                            'value' => isset( $attributes['column_1']['button_background_color'] ) ? $attributes['column_1']['button_background_color'] : O100NE_COLOR_WC_DEFAULT,
                            'type'  => 'style',
                        ],
                        ...
                        'button_font_family'      => [
                            'value' => isset( $attributes['column_1']['button_font_family'] ) ? $attributes['column_1']['button_font_family'] : O100NE_DEFAULT_FAMILY,
                            'type'  => 'style',
                        ],
                    ],
                    'column_2'   => [
                        ...
                        'font_family'             => [
                            'value' => isset( $attributes['column_2']['font_family'] ) ? $attributes['column_2']['font_family'] : O100NE_DEFAULT_FAMILY,
                            'type'  => 'style',
                        ],
                        ...
                        'button_text'             => [
                            'value' => isset( $attributes['column_2']['button_text'] ) ? $attributes['column_2']['button_text'] : __( 'Click me', 'order100' ),
                            'type'  => 'content',
                        ],
                        ...
                        'button_background_color' => [
                            'value' => isset( $attributes['column_2']['button_background_color'] ) ? $attributes['column_2']['button_background_color'] : O100NE_COLOR_WC_DEFAULT,
                            'type'  => 'style',
                        ],
                        ...
                        'button_font_family'      => [
                            'value' => isset( $attributes['column_2']['button_font_family'] ) ? $attributes['column_2']['button_font_family'] : O100NE_DEFAULT_FAMILY,
                            'type'  => 'style',
                        ],
                    ],
                    'column_3'   => [
                        ...
                        'font_family'             => [
                            'value' => isset( $attributes['column_3']['font_family'] ) ? $attributes['column_3']['font_family'] : O100NE_DEFAULT_FAMILY,
                            'type'  => 'style',
                        ],
                        ...
                        'button_text'             => [
                            'value' => isset( $attributes['column_3']['button_text'] ) ? $attributes['column_3']['button_text'] : __( 'Click me', 'order100' ),
                            'type'  => 'content',
                        ],
                        ...
                        'button_background_color' => [
                            'value' => isset( $attributes['column_3']['button_background_color'] ) ? $attributes['column_3']['button_background_color'] : O100NE_COLOR_WC_DEFAULT,
                            'type'  => 'style',
                        ],
                        ...
                        'button_font_family'      => [
                            'value' => isset( $attributes['column_3']['button_font_family'] ) ? $attributes['column_3']['button_font_family'] : O100NE_DEFAULT_FAMILY,
                            'type'  => 'style',
                        ],
                    ],
                ],
