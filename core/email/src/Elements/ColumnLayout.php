...
class ColumnLayout extends BaseElement {
        ...
        return [
            ...
            'data'      => [
                ...
                'column_width'                       => [
                    ...
                    'title'         => __( 'Column width (%)', 'order100' ),
                    'default_value' => [],
                ...
                'column_spacing'                     => [
                    ...
                    'component'     => 'Dimension',
                    'title'         => __( 'Column spacing', 'order100' ),
                ...
                'container_setting_group_definition' => [
                    ...
                    'title'       => __( 'Container layout settings', 'order100' ),
                ...
                'border_radius'                      => [
                    ...
                    'title'         => __( 'Border radius', 'order100' ),
                    'default_value' => [
                ...
                'inner_setting_group_definition'     => [
                    'component'   => 'GroupDefinition',
                    'title'       => __( 'Inner layout settings', 'order100' ),
                    'description' => __( 'Handle inner layout settings', 'order100' ),
                ],
                'inner_border_radius'                => [
                    'value_path'    => 'inner_border_radius',
                    'component'     => 'BorderRadius',
                    'title'         => __( 'Inner border radius', 'order100' ),
                    'default_value' => [
                ...
                'inner_background_color'             => [
                    ...
                    'component'     => 'Color',
                    'title'         => __( 'Inner background color', 'order100' ),
    ...
    private static function get_name( $amount ) {
        $column_names = [
            1 => __( 'One Column', 'order100' ),
            2 => __( 'Two Columns', 'order100' ),
            3 => __( 'Three Columns', 'order100' ),
            4 => __( 'Four Columns', 'order100' ),
        ];
