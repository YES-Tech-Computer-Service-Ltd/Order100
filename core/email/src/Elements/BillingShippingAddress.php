  ...
  <g>
    ...
    <rect x="6.32" y="4.9" width="1.93" height="1.01"/>
        ...
        $result = [
            'id'        => uniqid(),
            'type'      => self::$type,
            'name'      => __( 'Billing Shipping Address', 'order100' ),
            'icon'      => self::$icon,
            'group'     => 'woocommerce',
            'available' => true,
            'position'  => 180,
            'data'      => [
                ...
                'shipping_title'             => ElementsHelper::get_rich_text(
                    ...
                    [
                        ...
                        'title'         => __( 'Shipping title', 'order100' ),
                ...
                'shipping_address_content'   => [
                    ...
                    'component'     => '',
                    'title'         => __( 'Shipping Content', 'order100' ),
                    'default_value' => '[o100_shipping_address]',
                    'type'          => 'content',
                ],
                'billing_address_content'    => [
                    'value_path'    => 'billing_address_content',
                    'component'     => '',
                    'title'         => __( 'Billing Content', 'order100' ),
