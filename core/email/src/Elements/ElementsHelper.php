 ...
 *
 * Helper class for managing elements in O100ne.
 */
class ElementsHelper {
    /**
     ...
     *                  'value_path' => "src",
     *                  'title' => "Image URL",
     *                  'default_value' => O100NE_PLUGIN_URL . 'assets/images/woocommerce-logo.png'
     *              ]
     *
     * @return array An array containing image URL property data.
     */
    public static function get_media( $attributes, $config = [] ) {
        $default_src = esc_url( O100NE_PLUGIN_URL . 'assets/images/woocommerce-logo.png' );

        $default_config = [
            'value_path'    => 'src',
            'title'         => __( 'Image URL', 'order100' ),
    ...
    public static function get_font_family_selector( $attributes, $config = null ) {
            ...
            $default_config = [
                ...
                'default_value' => O100NE_DEFAULT_FAMILY,
                'type'          => 'style',
            ];
    ...
    public static function filter_available_elements( $elements, $email_id = '' ): array {
        ...
        $email = o100ne_get_email( $email_id );
