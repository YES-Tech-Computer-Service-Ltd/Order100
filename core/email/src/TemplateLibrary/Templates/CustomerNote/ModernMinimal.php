...
namespace Order100\Notification\Engine\TemplateLibrary\Templates\CustomerNote;
...
class ModernMinimal extends BaseTemplate {
    ...
    public function __construct() {
        parent::__construct();
        $this->id          = 'customer_note_modern_minimal';
        $this->email_type  = 'customer_note';
        $this->name        = 'Modern Minimal';
        $this->description = 'Note added to order notification';
        $this->elements    = [
                ...
                'children' => [
                    Column::get_object_data( 100, [ 'children' => [
                        Text::get_object_data( [
                            'rich_text'        => '<h1 style="font-size: 30px; font-weight: 600; text-align: center;">📝 A Note About Your Order</h1><p style="text-align: center; font-size: 18px;">Order #[o100_order_id is_plain="true"]</p>',
                            'text_color'       => '#333439',
            ...
            Text::get_object_data( [
                'rich_text'  => '<p>Hi <b>[o100_billing_first_name],</b></p><p>The following note has been added to your order:</p>',
                'text_color' => '#333439',
                'padding'    => [ 'top' => 15, 'right' => 50, 'bottom' => 10, 'left' => 50 ],
            ] ),
            ColumnLayout::get_object_data( 1, [
                ...
                'children' => [
                    Column::get_object_data( 100, [ 'children' => [
                        Text::get_object_data( [
                            'rich_text'  => '<p style="font-size: 16px; font-style: italic;">[o100_customer_note]</p>',
                            'text_color' => '#555555',
            ...
            Text::get_object_data( [
                'rich_text'  => '<p style="font-size: 16px;">[o100_order_link text_link="View Order Details →"]</p>',
                'text_color' => '#333439',
