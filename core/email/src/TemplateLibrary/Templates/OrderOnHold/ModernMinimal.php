...
namespace Order100\Notification\Engine\TemplateLibrary\Templates\OrderOnHold;
        ...
        $this->elements    = [
            ...
            ColumnLayout::get_object_data(
                ...
                [
                        ...
                        Column::get_object_data(
                            ...
                            [
                                'children' => [
                                    Text::get_object_data(
                                        [
                                            'rich_text'  => '<h1 style="font-size: 30px; font-weight: 600;">Order #[o100_order_id is_plain="true"]<br><br>You\'re just one step away</h1>',
                                            'text_color' => '#333439',
                            ...
                            [
                                'children' => [
                                    Image::get_object_data(
                                        [
                                            'align'   => 'left',
                                            'src'     => 'https://images.wpbrandy.com/uploads/o100ne-on-hold-banner-icon.png',
                                            'width'   => 120,
                                            'padding' => [
                                                'top'    => 0,
                                                'right'  => 10,
                    ...
                    'background_image'       => [
                        'url'        => 'https://images.wpbrandy.com/uploads/o100ne-on-hold-banner-bg.png',
                        'position'   => 'custom',
                        'x_position' => 70,
                        'y_position' => 0,
                        'size'       => 'cover',
            ...
            Image::get_object_data(
                [
                    'src'     => 'https://images.wpbrandy.com/uploads/o100ne-on-hold-processing-bar.png',
                    'width'   => 600,
                    'padding' => [
                        'top'    => 0,
                        'right'  => 10,
            ...
            Text::get_object_data(
                [
                    'rich_text'  => '<p>Hi <b>[o100_billing_first_name] [o100_billing_last_name],</b></p><p>Thank you for your order! It\'s on-hold until we confirm that payment has been received. In the meantime, here\'s a reminder of what you ordered.</p>',
                    'text_color' => '#333439',
                    'padding'    => [
                        'top'    => 15,
                        'right'  => 50,
