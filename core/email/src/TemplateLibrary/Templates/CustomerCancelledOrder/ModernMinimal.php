...
namespace Order100\Notification\Engine\TemplateLibrary\Templates\CustomerCancelledOrder;
...
class ModernMinimal extends BaseTemplate {
    ...
    public function __construct() {
        parent::__construct();
        $this->id          = 'customer_cancelled_order_modern_minimal';
        $this->email_type  = 'customer_cancelled_order';
        $this->name        = 'Modern Minimal';
        $this->description = 'Customer notification for cancelled order';
        $this->elements    = [
                ...
                'children' => [
                    Column::get_object_data( 100, [ 'children' => [
                        Text::get_object_data( [
                            'rich_text'        => '<h1 style="font-size: 30px; font-weight: 600; text-align: center;">Your Order Has Been Cancelled</h1><p style="text-align: center; font-size: 18px;">Order #[o100_order_id is_plain="true"]</p>',
                            'text_color'       => '#333439',
            ...
            Text::get_object_data( [
                'rich_text'  => '<p>Hi <b>[o100_billing_first_name],</b></p><p>We\'re writing to let you know that your order #[o100_order_id is_plain="true"] has been cancelled. If you didn\'t request this cancellation, please contact us immediately.</p>',
                'text_color' => '#333439',
