...
namespace Order100\Notification\Engine\TemplateLibrary\Templates\NewOrder;
        ...
        $this->elements    = [
            ...
            ColumnLayout::get_object_data(
                ...
                [
                            ...
                            [
                                'children' => [
                                    Image::get_object_data(
                                        [
                                            'align'   => 'left',
                                            'src'     => 'https://images.wpbrandy.com/uploads/o100ne-new-order-banner-icon.png',
                                            'width'   => 120,
                                            'padding' => [
                                                'top'    => 0,
                                                'right'  => 10,
                    ...
                    'background_image'       => [
                        'url'        => 'https://images.wpbrandy.com/uploads/o100ne-new-order-banner-bg.png',
                        'position'   => 'custom',
                        'x_position' => 70,
                        'y_position' => 0,
                        'size'       => 'cover',
            ...
            Text::get_object_data(
                [
                    'rich_text'  => '<p>Hi <b>[o100_billing_first_name] [o100_billing_last_name],</b></p><p>You\'ve received the following order from [o100_billing_first_name] [o100_billing_last_name].</p>',
                    'text_color' => '#333439',
                    'padding'    => [
                        'top'    => 15,
                        'right'  => 50,
