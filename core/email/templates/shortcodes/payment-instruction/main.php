...
<div style="color:inherit;text-align: <?php echo esc_attr( $text_align ); ?>" class="o100_builder_instructions">
    <?php
...
if ( false !== $payment_gateway && ! empty( $payment_gateway->account_details ) && $direct_bank_transfer === $payment_gateway->get_method_title() ) {
    ...
    if ( ! empty( $bacs_accounts ) ) {
        ...
        foreach ( $bacs_accounts as $bacs_account ) {
            ...
            $account_html .= '<ul class="o100ne-bacs-bank-details">' . PHP_EOL;
        ...
        if ( $has_details ) {
            ...
            echo wp_kses_post( "<section class='o100ne-builder-wrap-account'> $account_html </section>" );
        }
    }//end if
}//end if
?>
