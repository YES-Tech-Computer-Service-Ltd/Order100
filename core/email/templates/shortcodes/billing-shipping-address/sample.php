...
$billing_address  = '<span>John Doe <br>O100ne <br>7400 Edwards Rd <br>Edwards Rd</span>';
$shipping_address = '<span>John Doe <br>O100ne <br>755 E North Grove Rd <br>Mayville, Michigan</span>';
...
$wrap_style  = TemplateHelpers::get_style(
    [
        'border' => 'solid 1px ' . O100NE_COLOR_BORDER_DEFAULT,
    ]
);

$text_style = TemplateHelpers::get_style(
    [
        'font-family' => TemplateHelpers::get_font_family_value( O100NE_DEFAULT_FAMILY ) . ' !important',
    ]
);
    ...
    <tbody>
        <tr>
            <td style="width: 50%; vertical-align: top;">
                <h2 style="padding: 0; margin: 0 0 12px 0; font-size: 20px; color: <?php echo esc_attr( O100NE_COLOR_WC_DEFAULT ); ?>"><?php esc_html_e( 'Billing Address', 'woocommerce' ); ?></h2>
                <div style="<?php echo esc_attr( $wrap_style ); ?>">
                    <div style="padding: 12px; color: <?php echo esc_attr( O100NE_COLOR_TEXT_DEFAULT ); ?>;">
            ...
            <td style="width: 50%; vertical-align: top;">
                <h2 style="padding: 12px; font-size: 20px; color: <?php echo esc_attr( O100NE_COLOR_WC_DEFAULT ); ?>"><?php esc_html_e( 'Shipping Address', 'woocommerce' ); ?></h2>
                <div style="<?php echo esc_attr( $wrap_style ); ?>">
                    <div style="padding: 12px; color: <?php echo esc_attr( O100NE_COLOR_TEXT_DEFAULT ); ?>;">
                        <address style="<?php echo esc_attr( $text_style ); ?>">
