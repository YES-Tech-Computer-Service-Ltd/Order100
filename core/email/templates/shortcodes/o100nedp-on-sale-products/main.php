        ...
        <tr style="vertical-align: baseline; text-align: center;">
            ...
            foreach ( $products as $product ) {
                if ( $product instanceof WC_Product ) {
                    ...
                    <td class="o100ne-o100nedp-on-sale-products" style="<?php echo esc_attr( $product_item_style ); ?>">
                        <!-- Product Image -->
                        ...
                        <!-- Prices -->
                        <div style="<?php echo esc_attr( $prices_container_style ); ?>" class="o100ne-o100nedp-on-sale-products__item-price">
                            <?php if ( ! empty( $sale_price ) ) : ?>
                                <span style="<?php echo esc_attr( $sale_price_style ); ?>" class="o100ne-item-sale-price">
                                            <?php echo wp_kses_post( $currency_symbol ); ?><?php echo wp_kses_post( $sale_price ); ?> -
                                </span>
                            <?php endif; ?>

                            <?php if ( ! empty( $regular_price ) ) : ?>
                                <span style="<?php echo esc_attr( empty( $sale_price ) ? $sale_price_style : $regular_price_style ); ?>" class="o100ne-item-regular-price">
                        ...
                        <a style="<?php echo esc_attr( $button_buy_now_style ); ?>" href="<?php echo esc_url( $product_link ); ?>" target="_blank">
                            <?php echo esc_html__( 'BUY NOW', 'order100' ); ?>
                        </a>
