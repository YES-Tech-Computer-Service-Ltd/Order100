...
<tbody style="<?php echo esc_attr( $table_td_style ); ?>">
    <tr style="<?php echo esc_attr( $table_td_style ); ?>">
        <th class="td o100ne-order-details-download-title--product" colspan="1" scope="col" style="<?php echo esc_attr( $table_td_style ); ?> font-size: <?php echo esc_attr( $table_heading_font_size ); ?>px;"><?php o100ne_kses_post_e( $product_title ); ?></th>
        <th class="td o100ne-order-details-download-title--expires" colspan="1" scope="col" style="<?php echo esc_attr( $table_td_style ); ?> font-size: <?php echo esc_attr( $table_heading_font_size ); ?>px;"><?php o100ne_kses_post_e( $expires_title ); ?></th>
        <th class="td o100ne-order-details-download-title--download" colspan="1" scope="col" style="<?php echo esc_attr( $table_td_style ); ?> font-size: <?php echo esc_attr( $table_heading_font_size ); ?>px;"><?php o100ne_kses_post_e( $download_title ); ?></th>
    </tr>
    <tr style="<?php echo esc_attr( $table_td_style ); ?>">
        <td class="td o100ne-order-details-download-content--product" colspan="1" scope="col" style="<?php echo esc_attr( $table_td_style ); ?> font-size: <?php echo esc_attr( $table_content_font_size ); ?>px;">
        <?php
        if ( $show_product_image ) :
            ...
            <?php else : ?>
            <a href="" style="<?php echo esc_attr( $table_link_style ); ?>">
                <?php esc_html_e( 'Downloadable Product', 'order100' ); ?>
            </a>
            <?php endif; ?>
        </td>
        <td class="td o100ne-order-details-download-content--expires" colspan="1" scope="col" style="<?php echo esc_attr( $table_td_style ); ?> font-size: <?php echo esc_attr( $table_content_font_size ); ?>px;">
            <time datetime="2021-02-13" title="1613174400"> <?php echo wp_kses_post( wc_format_datetime( new WC_DateTime() ) ); ?></time>
        </td>
        <td class="td o100ne-order-details-download-content--download" colspan="1" scope="col" style="<?php echo esc_attr( $table_td_style ); ?> font-size: <?php echo esc_attr( $table_content_font_size ); ?>px;">
            <a href="" style="<?php echo esc_attr( $table_link_style ); ?>" ><?php esc_html_e( 'Download.doc', 'order100' ); ?></a>
        </td>
    </tr>
</tbody>
