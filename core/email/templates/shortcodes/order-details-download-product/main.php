...
if ( ! empty( $order_data ) ) :
    ...
    $addon_file_downloads = apply_filters( 'o100_addon_download_files', [], $args );
                ...
                if ( $show_product_image ) :
                    ...
                    ?>
                        <div class="o100ne-product-download-image">
                            ...
                            <?php
                            if ( ( $show_product_image && 'bottom' === $image_position ) || $is_placeholder ) {
                                echo wp_kses_post( "<span class='o100ne-product_image_position__bottom' style='margin-top: 5px;'>" );
                                require O100NE_PLUGIN_PATH . 'templates/shortcodes/order-details/order-items/image-content.php';
                                echo ( '</span>' );
                            }
                            ?>
