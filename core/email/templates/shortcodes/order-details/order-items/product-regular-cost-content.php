...
$price = wc_price( $product_regular_price, [ 'currency' => $order_data->get_currency() ] );

if ( ! empty( $price ) && $price !== $order_data->get_formatted_line_subtotal( $item ) ) {
    ?>
        <del class="o100ne-product-regular-price" style="padding-right:5px"> <?php echo wp_kses_post( $price ); ?> </del>
    <?php
}
