...
?>
    ...
    <h1 class="o100ne-customizer-element-title__title" style="<?php echo esc_html( $title_style ); ?>">
        <?php echo esc_html( $data['title'] ); ?>
    </h1>
    <?php if ( ! empty( $data['subtitle'] ) ) : ?>
        <h4 class="o100ne-customizer-element-title__subtitle" style="<?php echo esc_html( $subtitle_style ); ?>">
