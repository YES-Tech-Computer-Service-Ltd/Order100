...
$direction_rtl = o100ne_get_email_direction();
...
ob_start();
?>
<table class="o100ne-customizer-element-social" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse: collapse; margin: <?php echo esc_attr( $table_margin ); ?>; width: 100%;">
    <tr>
        <td style="text-align: <?php echo esc_attr( $data['align'] ?? 'center' ); ?>;">
        <?php foreach ( $data['icon_list'] as $key => $el ) : ?>
            <?php
            $img_url     = O100NE_PLUGIN_URL . 'assets/images/social-icons/' . $el['icon'] . '/' . $theme[ $data['theme'] ] . '.png';
            ...
            ?>
            <span class="o100ne-social-icon-item" style="<?php echo esc_attr( $item_style ); ?>">
