...
$data_column_default = is_array( $data['text_list']['column_1'] ) && ! empty( $data['text_list']['column_1'] ) ? $data['text_list']['column_1'] : [
    ...
    'font_family' => O100NE_DEFAULT_FAMILY,
    'padding'     => [
        'top'    => '10',
        'right'  => '10',
        'bottom' => '10',
    ...
    'button'      => [
        ...
        'font_size'        => '13',
        'url'              => '#',
        'background_color' => O100NE_COLOR_WC_DEFAULT,
        'text_color'       => '#fff',
        'padding'          => [
            'top'    => '0',
            'right'  => '0',
...
<table  className="o100ne-table-text-list"  width="100%" cellspacing="0" cellpadding="0" border="0" style="width: 100%;table-layout: fixed;">
        <tbody>
            <tr>
                <!-- Column 1 -->
                <td valign="top" style="<?php echo esc_attr( $column_style ); ?>">
                    <table style="width: 100%;table-layout: fixed;">
                        <tbody>
                            <tr>
                                <td>
                                    <div class="o100ne-table-text-list-column" style="<?php echo esc_attr( $column_1_text_style ); ?> ">
                            ...
                            <tr>
                                <td class="o100ne-table-text-list-column">
                ...
                <td valign="top" style="<?php echo esc_attr( $column_style ); ?>">
                    <table style="width: 100%;table-layout: fixed;">
                        <tbody>
                            <tr>
                                <td>
                                    <div class="o100ne-table-text-list-column" style="<?php echo esc_attr( $column_2_text_style ); ?>">
