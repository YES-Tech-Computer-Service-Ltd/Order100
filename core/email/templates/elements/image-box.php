...
$data_column_1 = [
    ...
    'width'   => '242',
    'url'     => '#',
    'image'   => O100NE_PLUGIN_URL . 'assets/images/woocommerce-logo.png',
    'padding' => [
        'top'    => '10',
        'right'  => '10',
        'bottom' => '10',
...
?>
    <table style="width: 100%;">
        <tbody>
            <tr>
                <td class="o100ne-table-image-box-column" align="<?php echo esc_attr( $data_column_1['align'] ); ?>" width="50%" style="<?php echo esc_attr( $column_1_style ); ?>">
                    <div>
                ...
                <td class="o100ne-table-image-box-column" width="50%" style="<?php echo esc_attr( $column_2_style ); ?>" > 
